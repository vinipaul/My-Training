...
public class ManageExpensePage {
	...
	@FindBy(xpath = "//a[@href='https://groceryapp.uniqassosiates.com/admin/expense' and @class='small-box-footer']")WebElement manageExpenseLink;
	@FindBy (xpath = "(//i[@class='fas fa-trash-alt'])[1]") WebElement deleteIcon;
	@FindBy (xpath = "(//tbody//child::tr//child::td)[1]") WebElement supposeddeleteTitle;
