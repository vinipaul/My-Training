...
@FindBy(xpath = "//input[@id='title']") WebElement titleETextBox;
@FindBy(xpath = "//input[@id='page']") WebElement pageTextBox;
@FindBy(xpath = "//button[@type='submit']") WebElement saveButton;
@FindBy(xpath = "//a[contains(@class,'btn btn-rounded btn-primary')]") WebElement searchButton;
@FindBy (xpath = "//input[@placeholder='Title']") WebElement ListPageTitleTextBox;
@FindBy (xpath ="//button[@name='Search']") WebElement ListPageSearchButton;
@FindBy (xpath = "//span[@id='res']//child::center") WebElement resultNotFound;
...
@FindBy(xpath = "//a[@href='https://groceryapp.uniqassosiates.com/admin/list-page' and @class='small-box-footer']") WebElement managepagesLink;
@FindBy(xpath = "((//tbody//tr)[1]//child::td)[4]") WebElement newlyAddedPage;
@FindBy(xpath = "((//tbody//tr)[1]//child::td)[1]") WebElement newlyAddedTitle;
